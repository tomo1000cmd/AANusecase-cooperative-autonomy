...
from bt_msgs.action import RoleLelyCa


class CooperativeAgent(Node):
    """
    ...
    def __init__(self):
        ...
        self.action_client = ActionClient(self, RoleLelyCa, 'ca')

        # Finally
        self.get_logger().info("'{}' initialized".format(self.my_id))

    def send_goal(self):
        goal_msg = RoleLelyCa.Goal()
