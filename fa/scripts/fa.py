...
from bt_msgs.action import RoleLelyFa


class ForcastingAgent(Node):
    """
    ...
    def __init__(self):
        ...
        self.action_client = ActionClient(self, RoleLelyFa, 'fa')

        # Finally
        self.get_logger().info("'{}' initialized".format(self.my_id))

    def send_goal(self):
        goal_msg = RoleLelyFa.Goal()
