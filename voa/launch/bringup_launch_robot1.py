...
def get_setting():
    ...
    try:
        ...
        print(e) 
    print("[INFO] [USING_SIM_TIME]:the configration for sim time is: "+using_sim_time)
    return using_sim_time
...
def generate_launch_description():
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(bringup_dir, 'config', 'params_' + vehicle_id + '.yaml'),
